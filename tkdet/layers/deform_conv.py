...
class DeformConv(nn.Module):
    ...
    def __repr__(self):
        ...
        tmpstr += ", bias=False"
        if self.norm is not None:
            tmpstr += f", norm={self.norm.__class__.__name__}"
        if self.activation is not None:
            tmpstr += f", activation={self.norm.__class__.__name__}"
        tmpstr += ")"
        return tmpstr
...
class ModulatedDeformConv(nn.Module):
    ...
    def __repr__(self):
        ...
        if self.norm is not None:
            tmpstr += f", norm={self.norm.__class__.__name__}"
        if self.activation is not None:
            tmpstr += f", activation={self.activation.__class__.__name__}"
        tmpstr += ")"
        return tmpstr
