...
def create_instances(predictions, image_size, conf_threshold=0.5):
    ...
    ret.scores = score
    ret.pred_boxes = Boxes(BoxMode.convert(bbox, BoxMode.XYWH_ABS, BoxMode.XYXY_ABS))
...
if __name__ == "__main__":
    ...
    for dic in tqdm.tqdm(dicts):
        ...
        predictions = create_instances(pred_by_image[dic["image_id"]], img.shape[:2], args.conf_threshold)
